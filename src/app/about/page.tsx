  ...
  return (
    <main className='h-full'>
      <div className=' flex h-full flex-col justify-center w-full mx-auto my-auto max-w-[1400px]'>
        ...
        <div className="pt-10 h-full flex justify-center items-center text-violet-900 text-4xl font-semibold font-['Concert One'] ">
          <h1>About</h1>
        </div>
        <div className='flex justify-center items-center pt-14 pb-20  w-full h-full'>
