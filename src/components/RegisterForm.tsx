        ...
        <form action='' className='w-full max-w-md rounded-md flex flex-col gap-4 '>
          ...
          <div className='mb-4 flex'>
            <input
              ...
              required
              autoComplete='off'
              className='w-full p-2 border rounded-md bg-purple-500 bg-opacity-5 placeholder-purple-700 border-purple-900 focus:outline-none focus:border-violet-600 focus:placeholder-violet-500 focus:bg-opacity-0 text-purple-800' placeholder='Confirm password:'
            />
